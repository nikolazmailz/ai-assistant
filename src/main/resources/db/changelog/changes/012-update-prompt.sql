...
При создании новых таблиц и столбцов всегда применяй, что значения могу быть null.
При создании нового диалога у пользователя, всегда остальные диалоги этого пользователя переводи is_active в значение false
',
    TRUE
);
